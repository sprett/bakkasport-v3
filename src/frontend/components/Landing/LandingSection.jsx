              ...
              <figure>
                <div className="aspect-w-12 aspect-h-7 lg:aspect-none">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1548061435-d56a87bdd05a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <div className="mt-5 prose prose-indigo text-gray-300 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              ...
              <p>
                ...
                <h3 className='text-white'>How we helped</h3>        
              <p>
