...
function createOperationToPatches(portableTextFeatures) {
  ...
  function insertTextPatch(editor, operation, beforeValue) {
    ...
    var prevChild = _slate.Editor.isBlock(editor, prevBlock) && prevBlock.children[operation.path[1]];
  ...
  function insertNodePatch(editor, operation, beforeValue) {
    ...
    if (!_slate.Editor.isBlock(editor, block)) {
    ...
    if (operation.path.length === 1) {
      ...
      var targetKey = operation.path[0] === 0 ? block._key : beforeBlock === null || beforeBlock === void 0 ? void 0 : beforeBlock._key;
