...
var uploadsAssetUploadEpic = function (action$) {
    return action$.pipe(operators_1.filter(exports.uploadsActions.uploadRequest.match), operators_1.mergeMap(function (action) {
        var _a = action.payload, file = _a.file, forceAsAssetType = _a.forceAsAssetType;
        ...
        operators_1.filter(function (hash) { return !!hash; }), 
...
var uploadsCheckRequestEpic = function (action$, state$) {
    return action$.pipe(operators_1.filter(exports.uploadsActions.checkRequest.match), operators_1.withLatestFrom(state$), operators_1.mergeMap(function (_a) {
        ...
        var filter = constructFilter_1.default({
