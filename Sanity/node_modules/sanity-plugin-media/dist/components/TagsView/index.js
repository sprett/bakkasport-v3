...
var TagsView = function () {
    ...
    return (react_1.default.createElement(ui_1.Box, { flex: 1, style: {
        ...
        react_1.default.createElement(PanelHeader_1.default, { allowCreate //
            : true, light: hasPicked, title: hasPicked ? 'Tags (in selection)' : 'Tags' }),
        !hasTags && (react_1.default.createElement(ui_1.Box, { padding: 3 },
        ...
        hasTags && react_1.default.createElement(Tags_1.default, null)));
};
