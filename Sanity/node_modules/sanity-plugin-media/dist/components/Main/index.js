...
var theme_2 = require("../../modules/theme");
var Main = react_1.forwardRef(function (props, ref) {
    var onClose = props.onClose, onSelect = props.onSelect, tool = props.tool;
    var dispatch = react_redux_1.useDispatch();
    var colorScheme = useTypedSelector_1.default(function (state) { return state.theme.colorScheme; });
    ...
    var handleToggleColorScheme = function () {
        dispatch(theme_2.themeActions.toggleColorScheme());
    };
    // Close on escape key press
    useKeyPress_1.default('escape', onClose);
    useKeyPress_1.default('shift+s', handleToggleColorScheme);
    return (react_1.default.createElement(ui_1.ThemeProvider, { scheme: colorScheme, theme: ui_1.studioTheme },
