...
var TagsAll = function () {
    ...
    return (react_1.default.createElement(ui_1.Box, null,
        react_1.default.createElement(PanelHeader_1.default, { allowCreate: true, title: "Tags" }),
        ...
        react_1.default.createElement(TagPanel_1.default, { actions: ['delete', 'edit', 'search'], tags: tags })));
};
exports.default = TagsAll;
