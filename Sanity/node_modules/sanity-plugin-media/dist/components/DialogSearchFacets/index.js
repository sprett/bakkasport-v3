...
var DialogSearchFacets = function (props) {
    ...
    return (react_1.default.createElement(Dialog_1.default, { header: "Filters", id: id, onClose: handleClose, width: 1, zOffset: constants_1.Z_INDEX_DIALOG },
        react_1.default.createElement(ui_1.Box, { padding: 3, style: {
                height: '100%'
