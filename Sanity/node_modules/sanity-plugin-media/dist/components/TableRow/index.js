...
var TableRow = function (props) {
    ...
    return (react_1.default.createElement(ContainerGrid, { onClick: selected ? undefined : handleClick, selected: selected, style: style, sx: {
        ...
        react_1.default.createElement(theme_ui_1.Box, { sx: {
            ...
            react_1.default.createElement(ui_1.Flex, { align: "center", justify: "center", style: { height: '100%', position: 'relative' } },
                react_1.default.createElement(ui_1.Box, { style: { height: '100%', opacity: opacityPreview, position: 'relative' } },
                    typeGuards_1.isFileAsset(asset) && react_1.default.createElement(FileIcon_1.default, { asset: asset, width: "40px" }),
        ...
        react_1.default.createElement(theme_ui_1.Box, { sx: {
            ...
            react_1.default.createElement(ui_1.Text, { size: 1, style: { lineHeight: '2em' }, textOverflow: "ellipsis" }, asset.originalFilename)),
        react_1.default.createElement(theme_ui_1.Box, { sx: {
        ...
        react_1.default.createElement(theme_ui_1.Box, { sx: {
            ...
            react_1.default.createElement(ui_1.Tooltip, { content: react_1.default.createElement(ui_1.Box, { padding: 2, style: {
                        minWidth: '110px',
                        textAlign: 'center'
                    } },
                    react_1.default.createElement(ui_1.Text, { size: 1 }, "has references")), placement: "left" },
                react_1.default.createElement(ui_1.Text, { size: 1 },
                    react_1.default.createElement(StyledWarningOutlineIcon, { color: "critical" }))))))));
};
exports.default = react_1.memo(TableRow);
