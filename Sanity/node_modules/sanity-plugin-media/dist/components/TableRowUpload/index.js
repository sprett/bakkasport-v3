...
var TableRowUpload = function (props) {
    ...
    return (react_1.default.createElement(theme_ui_1.Grid, { sx: {
            alignItems: 'center',
            bg: color_1.hues.gray[950].hex,
        ...
        react_1.default.createElement(theme_ui_1.Box, { sx: {
            ...
            react_1.default.createElement(ui_1.Box, { style: { height: '100%', position: 'relative' } },
                ...
                !isComplete && (react_1.default.createElement(ui_1.Flex, { align: "center", justify: "center", style: {
                        position: 'absolute',
                        height: '100%',
                        left: 0,
                        top: 0,
